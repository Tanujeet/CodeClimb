const Footer = () => {
  return (
    <footer className="w-full px-12 py-6 pb-12 bg-[#d4c9c9]/90 text-black backdrop-blur-md border-t border-black/10">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
        <a
          href="/"
          className="text-xl font-bold font-[Knewave] hover:text-blue-600"
        >
          CodeClimb
        </a>
        <div>
          <div className="flex items-center p-1 rounded-2xl border border-slate-400 gap-2">
            <a
              ...
              className="p-2 rounded-xl hover:bg-slate-600/80 transition ease-in-out duration-200"
            >
